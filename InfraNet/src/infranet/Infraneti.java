...
public class Infraneti {
    ...
    public static void main(String[] args) {
        ...
        sc.nextLine(); // IMPORTANTE: Faz com que o usuário possa digitar os valores SIM / NÃO no código. Sem eles não será possível por conta do armazenamento / buffer do Java.
        ...
        System.out.printf("\nO valor do seu salário líquido é: R$ %.2f\n", salarioLiquido); // Resultado gerado referente ao salário líquido.
        System.out.println("O valor do desconto foi de:\n"); // Resultado gerado referente ao desconto

        if (sal > 7087.22) {
            System.out.println(" INSS: R$ 570,88"); // o if else serve para valores maiores que 7098,22 pois a partir desse valor o inss passa a ser uma taxa única (570,88)  
        } else {
        ...
        String respostavt = sc.nextLine() .trim();  // O .trim faz com que o Scanner leia a linha mesmo contendo espaços, como invés de"Sim", "  Sim", ou "Sim  "
        ...
        } else if (respostavt.equalsIgnoreCase("não") || respostavt.toLowerCase().startsWith("n")) // O .equalsIgnoreCase faz com que o código não seja sensível à letras maiúsculas ou minúsculas, já o .toLowerCase faz com que o código seja transformado em minúsculo na transcrição do mesmo para o Eclipse. 
        	{
